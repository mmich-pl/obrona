- [[#Szacowanie złożoności algorytmów, klasy złożoności problemów algorytmicznych.|Szacowanie złożoności algorytmów, klasy złożoności problemów algorytmicznych.]]
	- [[#Szacowanie złożoności algorytmów, klasy złożoności problemów algorytmicznych.#Notacja O|Notacja O]]
	- [[#Szacowanie złożoności algorytmów, klasy złożoności problemów algorytmicznych.#Notacja Ω|Notacja Ω]]
	- [[#Szacowanie złożoności algorytmów, klasy złożoności problemów algorytmicznych.#Notacja Θ|Notacja Θ]]
	- [[#Szacowanie złożoności algorytmów, klasy złożoności problemów algorytmicznych.#Klasy złożoności|Klasy złożoności]]
- [[#Najważniejsze algorytmy wyszukiwania i sortowania, przegląd i zastosowania.|Najważniejsze algorytmy wyszukiwania i sortowania, przegląd i zastosowania.]]
	- [[#Najważniejsze algorytmy wyszukiwania i sortowania, przegląd i zastosowania.#Algorytmy sortowania|Algorytmy sortowania]]
		- [[#Algorytmy sortowania#Bubble sort|Bubble sort]]
		- [[#Algorytmy sortowania#Selection sort|Selection sort]]
		- [[#Algorytmy sortowania#Merge sort|Merge sort]]
		- [[#Algorytmy sortowania#Quick sort|Quick sort]]
		- [[#Algorytmy sortowania#Radix sort|Radix sort]]
	- [[#Najważniejsze algorytmy wyszukiwania i sortowania, przegląd i zastosowania.#Algorytmy wyszukiwania|Algorytmy wyszukiwania]]
		- [[#Algorytmy wyszukiwania#Wyszukiwanie liniowe|Wyszukiwanie liniowe]]
		- [[#Algorytmy wyszukiwania#Wyszukiwanie binarne|Wyszukiwanie binarne]]
		- [[#Algorytmy wyszukiwania#Algorytm turniejowy|Algorytm turniejowy]]
		- [[#Algorytmy wyszukiwania#Wybór elementu k-tego co do wielkości|Wybór elementu k-tego co do wielkości]]
- [[#Charakterystyka i zastosowania podstawowych struktur danych: stos, kolejka, kolejka priorytetowa, struktura Find-Union, słownik.|Charakterystyka i zastosowania podstawowych struktur danych: stos, kolejka, kolejka priorytetowa, struktura Find-Union, słownik.]]
	- [[#Charakterystyka i zastosowania podstawowych struktur danych: stos, kolejka, kolejka priorytetowa, struktura Find-Union, słownik.#Stos|Stos]]
		- [[#Stos#Operacje na wykonywane na stosach|Operacje na wykonywane na stosach]]
		- [[#Stos#Implementacja statyczna z użyciem tablicy|Implementacja statyczna z użyciem tablicy]]
		- [[#Stos#Implementacja dynamiczna z użyciem listy|Implementacja dynamiczna z użyciem listy]]
	- [[#Charakterystyka i zastosowania podstawowych struktur danych: stos, kolejka, kolejka priorytetowa, struktura Find-Union, słownik.#Kolejki priorytetowe (Priority Queue)|Kolejki priorytetowe (Priority Queue)]]
		- [[#Kolejki priorytetowe (Priority Queue)#Operacje na wykonywane na kolejkach|Operacje na wykonywane na kolejkach]]
- [[#Drzewa binarne i drzewa n-arne w algorytmice. Charakterystyka, sposoby implementacji i zastosowania.|Drzewa binarne i drzewa n-arne w algorytmice. Charakterystyka, sposoby implementacji i zastosowania.]]
	- [[#Drzewa binarne i drzewa n-arne w algorytmice. Charakterystyka, sposoby implementacji i zastosowania.#Drzewo|Drzewo]]
		- [[#Drzewo#Przodek i potomek|Przodek i potomek]]
		- [[#Drzewo#Poddrzewo|Poddrzewo]]
		- [[#Drzewo#Poprzednik i następnik|Poprzednik i następnik]]
		- [[#Drzewo#Liście|Liście]]
		- [[#Drzewo#Wysokość drzewa|Wysokość drzewa]]
	- [[#Drzewa binarne i drzewa n-arne w algorytmice. Charakterystyka, sposoby implementacji i zastosowania.#Drzewa binarne|Drzewa binarne]]
		- [[#Drzewa binarne#Implementacja drzew binarnych|Implementacja drzew binarnych]]
		- [[#Drzewa binarne#Poruszanie się po drzewie binarnym|Poruszanie się po drzewie binarnym]]
		- [[#Drzewa binarne#Rodzaje drzew binarnych|Rodzaje drzew binarnych]]
	- [[#Drzewa binarne i drzewa n-arne w algorytmice. Charakterystyka, sposoby implementacji i zastosowania.#Użycie drzew|Użycie drzew]]
- [[#Algorytmy rekurencyjne vs algorytmy iteracyjne, porównanie i omówienie podstawowych założeń konstrukcyjnych.|Algorytmy rekurencyjne vs algorytmy iteracyjne, porównanie i omówienie podstawowych założeń konstrukcyjnych.]]
